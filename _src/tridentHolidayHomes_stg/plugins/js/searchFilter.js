...
jQuery(document).ready(function ($) {
    ...
    jQuery(document.body).on('click', '.js-closeMobileFilterDestination', function () {
        jQuery('#rentalContent').removeClass('z-index-high');
    ...
    jQuery(document.body).on('click', '.js-openMobileFilterDestination', function () {
        jQuery('#rentalContent').addClass('z-index-high');
            ...
            setTimeout(function () {
                jQuery(element).each(function () {
                    if (jQuery(this).is('input')) {
                        ...
                        setTimeout(() => {
                            jQuery('#formFilterAccommodation .select2-selection__rendered').attr('title', linkContent);
                            jQuery('#formFilterAccommodation .select2-selection__rendered').text(linkContent);
                        }, "250");
